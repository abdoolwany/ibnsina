...
export const TABLE_LABELS: Record<string, string> = {
  ...
  'public.archive_review_sessions': 'جلسات مراجعة الأرشيف المؤقتة',
  'public.archive_review_records': 'سجلات مراجعة الأرشيف المؤقتة (تُحذف عند الإغلاق)',
  'storage.objects (bucket: monthly-archives)': 'ملفات الأرشيف الشهري (حاوية خاصة)',
